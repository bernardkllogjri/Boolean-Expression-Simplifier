...
void Expression::simplifyCompletely(){
    while(simplify()){} //per aq kohe sa mund te behet thjeshtimi, thjeshto
}
...
bool Expression::directlyApplyInferenceRule(int i){ //apliko rregullin ne poziionin i
